...
export default function ConsignmentDetailsForm() {
  ...
  return (
    <Card className="p-4 grid grid-cols-2 gap-y-2 gap-x-3">
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel info="hellow world!, this is info">Consignee</FormLabel>
            <FormControl>
              <div className="inline-flex items-center gap-1">
                <div className="relative h-fit">
                  <Input {...field} />
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel info="hellow world!, this is info">Customer</FormLabel>
            <FormControl>
              <div className="relative h-fit">
                <Input {...field} />
                <div className="absolute h-full top-0 right-0 inline-flex items-center justify-center px-3 ">
